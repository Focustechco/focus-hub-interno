...
import { FoxIcon, PaperclipIcon, SendIcon, XIcon } from './icons';
                    ...
                    >
                        <header className="flex items-center justify-between p-4 border-b border-[#2E2E2E] flex-shrink-0">
                            <div className="flex items-center gap-3">
                                <FoxIcon className="w-6 h-6 text-[#FF6B00]" />
                            ...
                            <div className="space-y-4">
                                {messages.map(msg => (
                                    <div key={msg.id} className={`flex items-start gap-3 ${msg.sender === 'user' ? 'justify-end' : ''}`}>
                                        {msg.sender === 'ia' && <div className="w-8 h-8 rounded-full bg-[#FF6B00] flex items-center justify-center flex-shrink-0"><FoxIcon className="w-5 h-5 text-white" /></div>}
                                ...
                                {isLoading && (
                                     <div className="flex items-start gap-3">
                                        <div className="w-8 h-8 rounded-full bg-[#FF6B00] flex items-center justify-center flex-shrink-0"><FoxIcon className="w-5 h-5 text-white" /></div>
