                ...
                >
                    ...
                    >
                        ...
                        <div className="space-y-4 overflow-y-auto custom-scrollbar pr-3 -mr-3">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-[#B3B3B3]">WhatsApp (com DDD)</label>
                                <input
                                    type="text"
                                    name="whatsapp"
                                    ...
                                    onChange={handleChange}
                                    className={`w-full mt-1 p-2 bg-[#2E2E2E] rounded-md border ${errors.whatsapp ? 'border-red-500' : 'border-transparent'} focus:border-[#FF6B00] focus:ring-0 transition-colors`}
                                />
                                {errors.whatsapp && <p className="text-red-500 text-xs mt-1">{errors.whatsapp}</p>}
                                <p className="text-xs text-[#555] mt-1">Insira apenas números (ex: 5511999999999)</p>
                            </div>

                            {/* WhatsApp Notification Preferences */}
                            {formData.whatsapp && (
                                <div className="bg-[#2E2E2E] p-4 rounded-lg space-y-3">
                                    <label className="block text-sm font-medium text-white mb-2">Notificações WhatsApp</label>

                                    <label className="flex items-center justify-between cursor-pointer">
                                        <span className="text-sm text-[#B3B3B3]">📋 Tarefas (atribuição, conclusão)</span>
                                        <input
                                            type="checkbox"
                                            name="whatsappNotifTasks"
                                            checked={formData.whatsappNotifications?.tasks !== false}
                                            ...
                                            className="h-4 w-4 rounded bg-[#1C1C1C] border-gray-600 text-[#FF6B00] focus:ring-[#FF6B00]"
                                        />
                                    </label>

                                    <label className="flex items-center justify-between cursor-pointer">
                                        <span className="text-sm text-[#B3B3B3]">⏰ Lembretes de prazo</span>
                                        <input
                                            type="checkbox"
                                            name="whatsappNotifReminders"
                                            checked={formData.whatsappNotifications?.reminders !== false}
                                            onChange={(e) => setFormData(prev => ({
                                                ...prev,
                                                whatsappNotifications: {
                                                    ...prev.whatsappNotifications,
                                    ...
                                    <label className="flex items-center justify-between cursor-pointer">
                                        <span className="text-sm text-[#B3B3B3]">☀️ Resumo diário (8h)</span>
                                        <input
                                            type="checkbox"
                                            name="whatsappNotifDailySummary"
                                            checked={formData.whatsappNotifications?.daily_summary !== false}
                                            onChange={(e) => setFormData(prev => ({
                                                ...prev,
                                                whatsappNotifications: {
                                                    ...prev.whatsappNotifications,
                                    ...
                                    <label className="flex items-center justify-between cursor-pointer">
                                        <span className="text-sm text-[#B3B3B3]">📌 Posts fixados no mural</span>
                                        <input
                                            type="checkbox"
                                            name="whatsappNotifPosts"
                                            checked={formData.whatsappNotifications?.posts === true}
                                            onChange={(e) => setFormData(prev => ({
                                                ...prev,
                                                whatsappNotifications: {
                                                    ...prev.whatsappNotifications,
                                    ...
                                    <div className="pt-2 border-t border-[#3E3E3E]">
                                        <label className="block text-xs text-[#B3B3B3] mb-1">Não Perturbe (horário silencioso)</label>
                                        <div className="flex items-center gap-2">
                                            <input
                                                type="time"
                                                name="whatsappDndStart"
                                                value={formData.whatsappDndStart || '22:00'}
                                                onChange={(e) => setFormData(prev => ({ ...prev, whatsappDndStart: e.target.value }))}
                                                className="bg-[#1C1C1C] border border-[#3E3E3E] rounded px-2 py-1 text-sm text-white"
                                            />
                                            <span className="text-[#B3B3B3]">até</span>
                                            <input
                                                type="time"
                                                name="whatsappDndEnd"
                                                value={formData.whatsappDndEnd || '07:00'}
                                                onChange={(e) => setFormData(prev => ({ ...prev, whatsappDndEnd: e.target.value }))}
                                                className="bg-[#1C1C1C] border border-[#3E3E3E] rounded px-2 py-1 text-sm text-white"
                                            />
                                        </div>
                                    </div>
