...
const CheckInScreen: React.FC<CheckInScreenProps> = ({ currentUser, checkIns, setCheckIns, users }) => {
    ...
    console.log('[CheckInScreen] Render:', {
        checkInsCount: (checkIns || []).length,
        lastCheckIn: myLastCheckIn,
        isCheckedIn
    });
    ...
    const handleCheckIn = async () => {
        console.log("Attempting Check-In...", { userId: currentUser.id });
        try {
            ...
            alert(`Erro ao registrar entrada: ${error instanceof Error ? error.message : 'Erro desconhecido'}`);
        }
    };
        ...
        return (
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-[#1C1C1C] p-6 rounded-lg shadow-md">
                    <h2 className="text-xl font-bold mb-4 flex items-center"><ClockIcon className="w-5 h-5 mr-2" /> Atividade Recente da Equipe</h2>
