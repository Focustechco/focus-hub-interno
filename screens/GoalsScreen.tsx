...
import { BriefcaseIcon, PaletteIcon, CpuIcon, TrendingUpIcon, TrophyIcon, XIcon, CheckSquareIcon, ShieldIcon, TargetIcon, EditIcon, Trash2Icon } from '../components/icons';
