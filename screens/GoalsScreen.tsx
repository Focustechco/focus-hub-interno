...
import { BriefcaseIcon, PaletteIcon, CpuIcon, TrendingUpIcon, TrophyIcon, XIcon, CheckSquareIcon, ShieldIcon, TargetIcon, EditIcon } from '../components/icons';
...
const GoalEditModal: React.FC<GoalEditModalProps> = ({ isOpen, onClose, onSave, goal }) => {
            ...
            {isOpen && (
                ...
                >
                    ...
                    >
                        ...
                        <h2 className="text-2xl font-bold mb-2">Editar Meta</h2>
                        <p className="text-sm text-[#B3B3B3] mb-4">Ajuste os detalhes da meta selecionada.</p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full mt-1 p-2 bg-[#2E2E2E] rounded-md border border-transparent focus:border-[#FF6B00] focus:ring-0"
                                />
                            </div>
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    className="w-full mt-1 p-2 bg-[#2E2E2E] rounded-md border border-transparent focus:border-[#FF6B00] focus:ring-0 resize-none"
                                />
                            </div>
